...
function Update-User {
    ...
    Param (
        ...
        # Status of the user.
        [Parameter()]
        [ValidateSet('ACTIVE', 'INACTIVE', 'CREATED', 'UNVERIFIED')]
        [String]
        $Status,
    ...
    if ($PSBoundParameters.ContainsKey('Email')) {
        $body.DetailedUserInfo.email = $Email
    }
    if ($PSBoundParameters.ContainsKey('IsAccountAdmin')) {
        $body.DetailedUserInfo.isAccountAdmin = $IsAccountAdmin
    }
