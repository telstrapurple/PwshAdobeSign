...
Describe 'Get-User' {
    ...
    It 'Requires Id to not be $null' {
        { Get-User -Id $null } | Should -Throw
    }

    It 'Handles a Id up to 512 characters' {
        Mock Invoke-Method { }
        Get-User -Id ''
        Should -Invoke Invoke-Method -Exactly 1
    }
